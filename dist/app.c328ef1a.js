...
},{"../dist/chart.esm":"node_modules/chart.js/dist/chart.esm.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var ws = new WebSocket('wss://stream.binance.com:9443/ws/etheur@trade'); // Containers

var orignal = document.querySelector('.orignal');
var predicted = document.querySelector('.predicted');
var indicator = document.querySelector('.indicator'); // Last price

var lastPrice = 0; // Websocket response on every message/change

ws.onmessage = function (event) {
  var data = JSON.parse(event.data);
  orignal.innerText = '$' + "".concat(parseFloat(data.p).toFixed(2));
  orignal.style.color = data.p > lastPrice ? 'green' : 'red';
  predicted.innerText = '$' + "".concat(parseFloat(data.p).toFixed(2));
...
var ctx = document.getElementById("myChart").getContext("2d"); // Config Variables

var numberElements = 100; // Globals

var updateCount = 0; // myChart
...
links.forEach(function (link) {
  link.addEventListener('click', function (e) {
    ...
    var currSection = document.querySelector(".".concat(e.target.attributes.data.value));
    currSection.classList.add('active');
  });
});
},{"chart.js/auto":"node_modules/chart.js/auto/auto.esm.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
